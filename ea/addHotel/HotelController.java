...
import com.epam.travelagency.web.dto.HotelDTO;
...
public class HotelController {
    ...
    public String getHotelAddForm() {
        return "hotelAddForm";
    }

    @RolesAllowed("ROLE_ADMIN")
    @GetMapping("/hotel/process_adding")
    public String processHotelAdding(HotelDTO hotel) {
        hotelService.add(
                hotel.getName(),
                Short.parseShort(hotel.getStars()),
                hotel.getWebsite(),
                new BigDecimal(hotel.getLatitude()),
                new BigDecimal(hotel.getLongitude()),
                HotelFeature.SECURITY);
